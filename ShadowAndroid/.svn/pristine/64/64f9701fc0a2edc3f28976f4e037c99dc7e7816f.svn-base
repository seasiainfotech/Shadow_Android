...
public class ProfileOccupationsAdapter extends BaseAdapter {

    private ArrayList<GetProfileResponse.Occupations> mList;
    private BaseActivity mActivity;
    private BaseFragment mBaseFragment;

    public ProfileOccupationsAdapter(BaseActivity context, ArrayList<?> mList) {
        this.mList = (ArrayList<GetProfileResponse.Occupations>) mList;
        this.mActivity = context;
    }

    public ProfileOccupationsAdapter(BaseFragment context, ArrayList<?> mList) {
        this.mList = (ArrayList<GetProfileResponse.Occupations>) mList;
