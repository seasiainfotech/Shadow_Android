...
public class SearchSimpleResponse implements Parcelable {
    ...
    protected SearchSimpleResponse(Parcel in) {
        message = in.readString();
        status = in.readString();
        data = in.createTypedArrayList(Data.CREATOR);
    }

    public static final Creator<SearchSimpleResponse> CREATOR = new Creator<SearchSimpleResponse>() {
        @Override
        public SearchSimpleResponse createFromParcel(Parcel in) {
            return new SearchSimpleResponse(in);
        }

        @Override
        public SearchSimpleResponse[] newArray(int size) {
            return new SearchSimpleResponse[size];
        }
    };
