...
public class InterestsAdapter extends BaseAdapter  {
    ...
    private ArrayList<EditProfileInput.Interest> mList;
    private BaseActivity mActivity;
    private BaseFragment mBaseFragment;

    public InterestsAdapter(BaseActivity context, ArrayList<?> mList) {
        this.mList = (ArrayList<EditProfileInput.Interest>) mList;
        this.mActivity = context;
    }

    public InterestsAdapter(BaseFragment context, ArrayList<?> mList) {
        this.mList = (ArrayList<EditProfileInput.Interest>) mList;
