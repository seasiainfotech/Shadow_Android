...
public interface GitHubService {
    ...
    @POST("checkAvailabilityOfEmail")
    Call<CheckEmailAvailabilityResponse> checkEmailAvailability(@Body CheckEmailAvailabilityInput Input);
    ...
    @POST("logout")
    Call<LogoutResponse> logout(@Body GetProfileInput getProfileInput);


    @POST("checkAvailablityOfCompany")
    Call<UsernameResponse> checkAvailablityOfCompany(@Body CheckCompanyInput getProfileInput);

    @POST("getAllAvailCompanies")
    Call<GetAvailableCompanyListResponse> getAvailCompList(@Body GetAvailableCompanyListInput getAvailableCompanyListInput);
