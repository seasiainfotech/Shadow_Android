...
import com.android.shadow.dialog.CompanyListDialog;
...
public class EditProfileUserActivity extends EditProfileBaseActivity implements View.OnClickListener,
        SchoolListDialog.SchoolNameCallback, EditProfilePresenter.OccupationCallback,
        InterestsDialog.EditInterestsCallback, CompanyListDialog.CompanyNameCallback {

    private EditText mUserNameEditText;
    protected TextView mUserNameTextView, mSchoolNmTextView, mCompNmEditText;
    ...
    protected void initViews() {
        ...
        mCompNmEditText = (TextView) findViewById(R.id.edit_text_add_comp);
        ...
        mCompNmEditText.setOnClickListener(this);
    ...
    private void addInterestsData() {
        if (profileResponse != null && profileResponse.getData() != null
            ...
            for (int i = 0; i < occuList.size(); i++) {
                ...
                if (occuList.get(i)!=null && occuList.get(i).getName() != null) {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.edit_text_add_comp:
                CompanyListDialog companyListDialog = new CompanyListDialog(this, this, 0);
                companyListDialog.showSchoolDialog(null);
                break;
            ...
            case R.id.image_view_save:
                ...
                userProfilePresenter.checkValidations(mInterestsList, mOccupationsList, mSelectedMediaList,
                        mUserId, mSchoolNmTextView.getText().toString(),
