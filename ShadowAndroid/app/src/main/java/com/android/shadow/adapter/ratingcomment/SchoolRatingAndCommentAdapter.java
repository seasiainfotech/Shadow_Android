...
public class SchoolRatingAndCommentAdapter extends RecyclerView.Adapter<SchoolRatingAndCommentAdapter.ViewHolder> {
    private ArrayList<GetAllRatingResponse.Data.SchoolRatings> mList;
    private BaseActivity mActivity;

    public SchoolRatingAndCommentAdapter(BaseActivity context, ArrayList<GetAllRatingResponse.Data.SchoolRatings> mList) {
        this.mList = (ArrayList<GetAllRatingResponse.Data.SchoolRatings>)mList;
        this.mActivity = context;
    }

    @Override
    public SchoolRatingAndCommentAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
