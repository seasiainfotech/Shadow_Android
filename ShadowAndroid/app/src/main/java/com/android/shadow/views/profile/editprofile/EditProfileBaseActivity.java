    ...
    protected void setProfileUrlData(ImageView urlTetxView, EditText urlEditText, View vew, String id, String text) {
        switch (id) {
            case TWITTER_KEY:
                ...
                if (text.length() >= 24) {
                    String urlt = text.substring(24, text.length());
                    urlEditText.setText(urlt);
                } else {
                    urlEditText.setText("");
                }
                break;
            case FACEBOOK_KEY:
                ...
                urlEditText.setVisibility(View.VISIBLE);
                if (text.length() >= 25) {
                    String urlf = text.substring(25, text.length());
                    urlEditText.setText(urlf);
                } else {
                    urlEditText.setText("");
                }
                vew.setVisibility(View.VISIBLE);
            ...
            case LINKEDIN_KEY:
                ...
                urlTetxView.setVisibility(View.VISIBLE);
             /*   StringTokenizer stringTokenizer=new StringTokenizer(text,".com/");
                ...
                if (text.length() >= 25) {
                    String urll = text.substring(25, text.length());
                    urlEditText.setText(urll);
                } else {
                    urlEditText.setText("");
                }
                urlEditText.setVisibility(View.VISIBLE);
            ...
            case GOOGLE_PLUS_KEY:
                ...
                vew.setVisibility(View.VISIBLE);
                if (text.length() >= 27) {
                    String urlgp = text.substring(27, text.length());
                    urlEditText.setText(urlgp);
                } else {
                    urlEditText.setText("");
                }
                break;
            case INSTAGRAM_KEY:
                ...
                urlEditText.setVisibility(View.VISIBLE);
                if (text.length() >= 26) {
                    String urli = text.substring(26, text.length());
                    urlEditText.setText(urli);
                } else {
                    urlEditText.setText("");
                }
                vew.setVisibility(View.VISIBLE);
            ...
            case GITHUB_KEY:
                ...
                vew.setVisibility(View.VISIBLE);
                if (text.length() >= 23) {
                    String urlgh = text.substring(23, text.length());
                    urlEditText.setText(urlgh);
                } else {
                    urlEditText.setText("");
                }
                break;
