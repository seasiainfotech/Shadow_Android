...
public class SchoolPresenter {
    ...
    public void getAllSchool(GetAllSchoolInput getAllSchoolInput) {
        ...
        try {
            Gson gson = new Gson();
            String schoolInput = gson.toJson(getAllSchoolInput, GetAllSchoolInput.class);
            Log.e("schoolInput-", schoolInput + "--sessionToken--" + ShadowApp.sessionToken + "");
        ...
        final Call<GetAllSchoolResponse> responseSchoolList = GetRestAdapter.getRestAdapter(true).getAllSchool(getAllSchoolInput);
