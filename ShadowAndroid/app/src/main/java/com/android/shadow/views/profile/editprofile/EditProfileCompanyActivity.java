...
public class EditProfileCompanyActivity extends EditProfileBaseActivity implements View.OnClickListener,
        EditProfilePresenter.OccupationCallback,CompanyListDialog.CompanyNameCallback {


    private static final int PLACE_AUTOCOMPLETE_REQUEST_CODE = 2;

    private TextView mCompNameTextView, mCompLocationTextView;
    private EditText mCompUrlEditText,mCompNameEditText;
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.edit_text_company_name:
