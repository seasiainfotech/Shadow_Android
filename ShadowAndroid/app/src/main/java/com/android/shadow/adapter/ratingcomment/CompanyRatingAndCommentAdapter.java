...
public class CompanyRatingAndCommentAdapter extends RecyclerView.Adapter<CompanyRatingAndCommentAdapter.ViewHolder> {
    private ArrayList<GetAllRatingResponse.Data.CompanyRatings> mList;
    private BaseActivity mActivity;

    public CompanyRatingAndCommentAdapter(BaseActivity context, ArrayList<GetAllRatingResponse.Data.CompanyRatings> mList) {
        this.mList = (ArrayList<GetAllRatingResponse.Data.CompanyRatings>) mList;
        this.mActivity = context;
    }

    @Override
    public CompanyRatingAndCommentAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
