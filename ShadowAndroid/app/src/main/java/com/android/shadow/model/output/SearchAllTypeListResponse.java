 ...
 */
public class SearchAllTypeListResponse  implements Parcelable{
    ...
    protected SearchAllTypeListResponse(Parcel in) {
        message = in.readString();
        status = in.readString();
        data = in.createTypedArrayList(Data.CREATOR);
    }

    public static final Creator<SearchAllTypeListResponse> CREATOR = new Creator<SearchAllTypeListResponse>() {
        @Override
        public SearchAllTypeListResponse createFromParcel(Parcel in) {
            return new SearchAllTypeListResponse(in);
        }

        @Override
        public SearchAllTypeListResponse[] newArray(int size) {
            return new SearchAllTypeListResponse[size];
        }
    };
    ...
    public class OccupationDTO
    {
        ...
        public String getTotalEmployers ()
        {
            return totalEmployers;
        }

        public void setTotalEmployers (String totalEmployers)
        {
        ...
        public String toString()
        {
            return "ClassPojo [id = "+id+", totalEmployers = "+totalEmployers+", description = "+description+", name = "+name+", salary = "+salary+"]";
        }
    }
    ...
    public static class Occupations implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeString(occupationTypeId);
        }
