    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.image_view_back:
              if (mThreeDotBtn.getVisibility() == View.VISIBLE){
                  finish();
              } else {
                  mThreeDotBtn.setVisibility(View.VISIBLE);
                  mThreeLineBtn.setVisibility(View.GONE);
                  mAllNameTextView.setVisibility(View.GONE);
            ...
            case R.id.Image_view_three_dot:
                ...
                /*  mThreeLineBtn.setBackgroundTintList(ColorStateList.valueOf(getResources().getColor(R.color.three_dot_gray)));
                    ...
                    mThreeDotBtn.setVisibility(View.GONE);
                    mSearchView.setVisibility(View.GONE);
                    mAllNameTextView.setVisibility(View.VISIBLE);
                   // mThreeLineBtn.setVisibility(View.VISIBLE);
                } catch (Exception e) {
...
//            mPager.setAdapter(mPagerAdapter);
    ...
    private void setAllTypePagerAdapter() {
        ...
        mPager.setAdapter(mPagerAdapter);
        setName(mAllList.get(0).getName());
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                setName(mAllList.get(i).getName());
    ...
    private void setSimplePagerAdapter() {
        ...
        mPager.setAdapter(mPagerAdapter3);
        setName(mSimpleList.get(0).getName());
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
            public void onPageScrolled(int i, float v, int i1) {
            ...
            @Override
            public void onPageSelected(int i) {
                setName(mSimpleList.get(i).getName());
                Log.e("pageSelected--", i + "--" + currentPageNumber);
                if (i == mAllList.size() - 1) {
                    currentPageNumber++;
    ...
    private void setLocationPagerAdapter() {
        mPagerAdapter2 = new ScreenSlideLocationPagerAdapter(getSupportFragmentManager(), mLocationList);
        mPager.setAdapter(mPagerAdapter2);
        setName(mLocationList.get(0).getName());
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            @Override
            public void onPageScrolled(int i, float v, int i1) {
            ...
            @Override
            public void onPageSelected(int i) {
                setName(mLocationList.get(i).getName());
                Log.e("pageSelected--", i + "--" + currentPageNumber);
                if (i == mAllList.size() - 1) {
                    currentPageNumber++;
